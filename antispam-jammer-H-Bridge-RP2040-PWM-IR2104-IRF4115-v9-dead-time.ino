/*
  ...
  Version 9: Dead-time implementation for IRFZ44N + IR2104 + FM modulation
             + sweep stop randomization for best results, not audible
  (C) Adam Loboda 2026
*/
...
void update_frequency_safe(uint32_t freq) {
    ...
    // CYCLE DUTY setting for dead time (can be used for AM modulation)
