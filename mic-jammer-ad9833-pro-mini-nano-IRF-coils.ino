/*
    ...
    Boards needed : 
    Arduino Pro Mini/Micro or other boards like Nano - please adjust SPI pin numbering
    AD9833 signal generator board
    TPA3116D2 board - audio amplifier module + potentiometer OR 
	use MOSFET driver TC4420 + MOSFET IRFB4115 + COILS 4.7milihenr per each 4 transducers 25KHz
    ...
    SCLK --> pin 13 SCK
    FSYNC --> pin 14 A0 (as AD9833 SS) - adjust this pin for you Arduino board
    DGND --> GND
    VCC --> VCC
    
    AD9833 PCB to MOSFET DRIVER or AUDIO AMPLIFIER
    AOUT  --> LEFT AUDIO IN + RIGHT AUDIO IN of TPA3116D2 OR TC4420 INPUT PIN
    AGND  --> AUDIO GND IN TPA3116D2 OR NOT CONNECTED WHEN TC4420

    REMEMBER TO CONNECT AD9833 TO 5V AND GND PINS OF ARDUINO BOARD
    ARDUINO HAS TO BE POWERED FROM 5V 
...
void loop() {
     ...
     uint16_t i,j,x;
	  ...
	  j = 1;
          ...
          // going down with frequency from to 24KHz 
    ...
    // now the opposite direction going up to 26KHz
