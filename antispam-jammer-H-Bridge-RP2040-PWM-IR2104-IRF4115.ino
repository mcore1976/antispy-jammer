...
// We are using GP1 and GP2 pins, they both belong to WM Slice 0
const int PIN_NORMAL = 1;    // GP1
const int PIN_INVERTED = 2;  // GP2 is Negated GP1
...
void setup() {
    // Initializing GP1/GP2 as PWM outputs
    ...
    // If PIN_NORMAL is GP2 (Channel B), and PIN_INVERTED is GP1 (Channel A):
    pwm_set_output_polarity(slice_num, true, false);
    // Now Channel A (GP1) is inverted channel B (GP2)
