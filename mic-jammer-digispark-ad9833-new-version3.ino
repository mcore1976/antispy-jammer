...
void loop() {
     ...
     uint16_t i = 26000;  // starting frequency for swinging
     uint8_t y;
     uint16_t x;

           // going down with frequency to 24000, randomized jumps
           x = 5;
           y =  rand()%10;   
           while (i >= 24000)
           { 
            ...
            // increment the interval to cover all the band
            x = x + y;           
           };


           // going up with frequency to 26000 again, randomized jumps
           x = 5;
           y =  rand()%10;
           while (i <= 26000)
           { 
