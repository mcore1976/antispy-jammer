/*
    ...
    Boards needed : 
    Arduino Pro Mini/Micro or other boards - please adjust SPI pin numbering
...
void loop() {
     ...
     uint16_t i,j,k, x;
	  ...
	  j = 1;
          ...
          // frequency value for jump  in between
           k = random(24500,25500);
          // starting frequency 
           i = 26000;

          // going down with frequency from j to k value
          while (i >= k)
          {
           i = i - j;
          ...
          // now making a random jump back in frequency 
          i = i + random(100,500);

          // going down with frequency from k to 24000
          while (i >= 24000)
          {
           i = i - j;
           ad9833_set_frequency(0, (double)i );
    ...
    // now the opposite direction going up to 26000 with frequency jump in beetween
	  ...
	  j = 1;
          ...
          // frequency value for jump  
           k = random(24500,25500);
          // starting frequency 
           i = 24000;

          // going from 24000 up to K value
          while (i <= k)
          {
           i = i + j;
           ad9833_set_frequency(0, (double)i );
