/*
    ...
    Boards needed : 
    ESP8266 board WEMOS D1 MINI or other - please adjust SPI pin CS numbering 
    AD9833 signal generator board
    TPA3116D2 - audio amplifier module + potentiometer

    CONNECTION EXAMPLE FOR  ESP8266 board WEMOS D1 MINI
    --------
    AD9833 PCB to WEMOS D1 Mini:
    SDATA --> pin D7 MOSI ( GPIO13 )
    SCLK --> pin D5 SCLK  ( GPIO14 )
    FSYNC --> pin D8 CS ( GPIO 15 ) - adjust this pin  FNC_PIN for you Arduino board down below
    DGND --> GND
    VCC --> VCC
