...
You can use 20kHz ultrasonic transducers (hard to get and very expensive but the most effective for jamming), 25kHz transducers (default model), 40 kHz (smallest effectivenes in jamming).
