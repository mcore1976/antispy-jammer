...
void loop() {
 ...
 uint16_t i,j;
          ...
          // generating  FM modulation over 20kHZ ULTRASOUND CARRIER
          // for android best is random infrasound
          j = random (28,44);
          // for iPhone best is fixed 45Hz value
          // j = 45;
          // starting frequency for swinging
          i = random(20500,21000);
          // going down with frequency to 19000
          while (i >= 19000)
          {
           i = i - j;
          ...
          // going up with frequency to 21000 again
          // starting frequency for swinging
          i = random(19000,19500);
          // generating  FM modulation over 20kHZ ULTRASOUND CARRIER
          // for android best is random infrasound
          j = random (28,44);
          // for iPhone best is fixed 45Hz value
