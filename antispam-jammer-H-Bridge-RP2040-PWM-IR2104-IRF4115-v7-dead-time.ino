/*
  ...
  Version 6: Dead-time implementation for IRFZ44N + IR2104 + FM/AM modulation randomization for best results
  (C) Adam Loboda 2026
*/
...
void update_frequency_safe(uint32_t freq) {
    ...
    uint32_t level = ( wrap /  2 ) + random(10,250) ; 
...
void loop() {
    ...
    while (i >= 24750 ) {
        ...
        // adding small randomization of FM modulation
        j = (j + random(1,5) ) % x;
