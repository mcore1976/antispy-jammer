...
void loop() {
  ...
  uint16_t i = 26000; 
           ...
           // generating RANDOM 7-15Hz INFRASOUND over 25kHZ ULTRASOUND CARRIER 
  
           // going down with frequency to 24000, randomized infrasound 7Hz-15Hz
           while (i >= 24000)
           { 
            i = i - random(7, 15);
           ...
           // going up with frequency to 26000 again, randomized infrasound 7Hz-15Hz
           while (i <= 26000)
           { 
            i = i + random(7, 15);
            ad9833_set_frequency(0, (double)i );
