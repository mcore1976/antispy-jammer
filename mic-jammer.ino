...
void loop() {
        ...
        uint8_t pulsewidth, i;
          ...
          for(sequence=0; sequence<1000; sequence++)
           ...
           // send HIGH VOLTAGE - on port P1 , P2 - this time square wave
           // P0 is GND for PAM8403 module audio input
           ...
           // send LOW VOLTAGE - on port P1 , P2 - this time square wave
           // P0 is GND for PAM8403 module audio input
           OUTPUTPORT = 0b00000000; 
           // now delay to achieve desired frequency
           for(i=0; i<pulsewidth; i++)
             {
              asm volatile (
